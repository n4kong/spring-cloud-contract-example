...
@AutoConfigureStubRunner(ids = {"io.pivotal:loginService:+:stubs:6565"}, stubsMode  = StubRunnerProperties.StubsMode.LOCAL)
...
//	
	...
	public void shouldSuccessfullySetPasswordV1() {
		// given:
		UserLoginV1 userloginv1 = new UserLoginV1("springdays1","123","123");
	    // when:
